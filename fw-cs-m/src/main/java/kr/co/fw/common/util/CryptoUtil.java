...
public class CryptoUtil {
	...
	// make 32byte key : "dkbyhealhting" ASCII to HEX= >
	// "67656e65786f6e6865616c6874696e67"
	...
	public static String makeSHA256(String src) {
		...
		String returnCode = "";
		if (src == null || "".equals(src) || src.length() == 64 || src.length() == 128) {
			return src;
		}
		try {
			...
			e.printStackTrace();
			logger.error("ERROR WHILE MAKING SHA-256 ENCODE. CHECK common.util.CyrptoUtil in common Module  [ERR MSG] ="
					+ e.getMessage());
			returnCode = src;
		}
